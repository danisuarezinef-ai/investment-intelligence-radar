...
from radar_learning import active_model, calibration_summary, detect_regime, build_portfolio, backtest_point_in_time, init_learning_db
...
def dashboard_payload():
    ...
    return {
      ...
      'portfolio':build_portfolio('1m'),'counts':counts,
