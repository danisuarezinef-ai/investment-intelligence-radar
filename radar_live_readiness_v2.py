...
def evaluate(metrics:dict[str,Any], *, human_approved:bool=False)->dict[str,Any]:
    ...
    return {'policy':POLICY,'checks':checks,'evidence_pass':evidence_pass,'human_approved':bool(human_approved),
            'ready_for_tiny_live_review':evidence_pass and bool(human_approved),'auto_promote':False,
