...
def deep_learning_cycle(force_predictions=False,regime='unknown'):
    ...
    return {'learning':learning,'champion_health':champion_health(),'champion_portfolio':champion_status(),'simulation':simulation_summary(),'real_trading':False}


def system_v2_health():
    return {'simulation':simulation_summary(),'memory':memory_health(),'learning':learning_v2_health(),'champion':champion_health(),'champion_portfolio':champion_status(),'real_trading':False}
