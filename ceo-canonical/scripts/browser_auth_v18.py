...
def main() -> int:
    ...
    (outdir / "browser_path_v18.txt").write_text(str(browser), encoding="utf-8")
    (outdir / "browser_profile_v18.txt").write_text(str(profile), encoding="utf-8")
    ...
    print("[PASS] Perfil de autenticacion preparado para EL MISMO provider de v18.")
    return 0
