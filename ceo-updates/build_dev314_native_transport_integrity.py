...
ROOT = pathlib.Path(os.environ.get("CEO_DEV314_BUILD_ROOT", "/tmp/ceo-dev314-native-transport"))
OLD_VERSION = "1.5.89-rc1-deterministic-completion"
VERSION = "1.5.90-rc1-native-transport-integrity"
...
def main() -> None:
    ...
    print(json.dumps({
        ...
        "invariants": [
            ...
            "dev313_deterministic_completion_inherited",
        ],
    }, indent=2))
