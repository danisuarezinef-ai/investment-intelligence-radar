...
def test_inherited_dev311_dev312_dev313_completion():
...
async def main_async():
    rows = {
        ...
        "inherited": test_inherited_dev311_dev312_dev313_completion(),
        "windows_native_live": await test_windows_native_reaches_google_without_real_key(),
    }
    print("DEV314_NATIVE_TRANSPORT_INTEGRITY_PASS")
    print(rows)
