...
BASE = REPO / "ceo-updates" / "CEO_1.5.91-rc1-field-endurance-certification.zip"
ROOT = pathlib.Path(os.environ.get("CEO_DEV316_BUILD_ROOT", "/tmp/ceo-dev316-native-transport"))
OLD_VERSION = "1.5.91-rc1-field-endurance-certification"
VERSION = "1.5.92-rc1-native-transport-integrity"
...
def main() -> None:
    ...
    print(json.dumps({
        ...
        "invariants": [
            ...
            "provider_outage_core_independence_inherited_from_dev314",
            "field_endurance_inherited_from_dev315",
            "dev311_to_dev315_hardening_inherited",
        ],
    }, indent=2))
