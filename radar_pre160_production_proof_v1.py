...
PROTECTED_PATHS=(
 ...
 'radar_supabase_sync.py','radar_supabase_sync_partitioned_v2.py','radar_learning_sync.py','radar_forward_engine.py','radar_forward_outcome_sync_v1.py','radar_closed_loop_runtime_v1.py','radar_champion_challenger_v1.py','radar_learning_engine_v3.py','radar_validation_runtime_v3.py','radar_operational_health_v2.py',
 'radar_forward_evidence_v2.py','radar_asset_taxonomy_v1.py','radar_brain_calibration_v2.py','radar_brain_competition_v3.py','radar_brain_readiness_v1.py','radar_brain_persistence_v1.py','radar_autonomous_simulator_v1.py','radar_autonomy_e2e_v1.py','radar_autonomous_paper_control_v1.py','radar_autonomous_learning_16_40_v1.py','radar_autonomous_learning_41_60_v1.py','radar_ceo_handoff_v1.py',
 ...
 'tools/pre160_integrity_ci.py','tools/pre160_201_270_integrity_ci.py','tools/pre160_271_310_integrity_ci.py','tools/pre160_311_370_integrity_ci.py','tools/pre160_repo_audit_v2.py','tools/autonomous_learning_16_40_integrity_ci.py','tools/autonomous_learning_41_60_integrity_ci.py','tools/radar_ceo_handoff_integrity_ci.py','PRE160_LEGACY_PR_RECONCILIATION.md','PRE160_TASKS_311_370.md',
)
