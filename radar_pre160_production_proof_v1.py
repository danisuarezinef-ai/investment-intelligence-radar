...
PROTECTED_PATHS=(
 ...
 'supabase/functions/radar-sync/index.ts','supabase/functions/radar-learning-sync/index.ts','supabase/functions/radar-retry-queue/index.ts','supabase/functions/radar-paper-engine-checkpoint/index.ts','supabase/functions/radar-pre160-evidence/index.ts','supabase/functions/radar-pre160-hardening/index.ts',
 'supabase/migrations/20260912093000_pre160_remote_retry_queue_v3.sql',
 '.github/workflows/pre160-hardening-production-audit.yml','.github/workflows/pre160-201-270-production-audit.yml','.github/workflows/pre160-271-310-production-audit.yml','.github/workflows/integration-ci.yml',
 'tools/pre160_integrity_ci.py','tools/pre160_201_270_integrity_ci.py','tools/pre160_271_310_integrity_ci.py','tools/pre160_repo_audit_v2.py','PRE160_LEGACY_PR_RECONCILIATION.md',
)
