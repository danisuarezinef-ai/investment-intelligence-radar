...
def audit(root='.'):
    ...
    if 'exec python cloud_service_v24.py' not in start:findings.append('START_NOT_V24')
    ...
    required=('radar_operational_closure_101_120_v1.py','radar_learning_governance_121_130_v2.py','radar_paper_certification_131_160_v1.py',
              'radar_operational_proof_161_170_v1.py','radar_paper_forward_maturity_v1.py','radar_execution_reality_171_190_v1.py','radar_paper_execution_evidence_v1.py',
              ...
              'tests/test_operational_proof_161_170_v1.py','tests/test_execution_reality_171_190_v1.py',
              'supabase/migrations/20260914013000_paper_forward_maturity_ledger.sql','supabase/migrations/20260914081000_paper_execution_reality_171_190.sql')
    for path in required:
        if not (root/path).exists():findings.append('MISSING_COMPONENT:'+path)
    for path in ('radar_paper_certification_131_160_v1.py','radar_operational_proof_161_170_v1.py','radar_execution_reality_171_190_v1.py'):
    ...
    return {'status':'PASS' if not findings else 'FAIL','findings':findings,'legacy_status':old.get('status'),'actual_entrypoint':'cloud_service_v24.py','real_trading':False}
