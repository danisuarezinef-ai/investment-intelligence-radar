...
def audit(root='.'):
    ...
    for path in ('radar_supabase_sync.py','cloud_service_v5.py','tests/test_supabase_sync_resilience.py','tests/test_post150_reliability_v1.py'):
    ...
    for token in ('WRITE_CONCURRENCY=20','mapConcurrent','portfolio_values immutable mismatch','portfolio_values origin collision','edge_ms'):
